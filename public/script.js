...
async function singleMovie() {
    ...
    // Making the output html by string interpolition <i class="fa-solid fa-heart"></i>
    var output = `
    ...
    <div class="movie-details">
        ...
        <p style="font-size: 20px; font-style: italic; color: #eeb127; margin-top: 10px;">
        ...
        <div class="fav-item">
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    ...
                    <div>
                        <i class="fa-solid fa-heart" style="cursor:pointer;" onClick=addTofavorites('${id}')></i>
                    </div>
                </div>
            </div>
        </div>
